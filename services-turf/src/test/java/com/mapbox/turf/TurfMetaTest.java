...
public class TurfMetaTest extends TestUtils {
  ...
  public void coordAllFeatureCollection() throws TurfException {
    ...
    assertEquals(5, TurfMeta.coordAll(featureCollection).size());
    assertEquals(0, TurfMeta.coordAll(featureCollection).get(0).latitude(), DELTA);
    assertEquals(0, TurfMeta.coordAll(featureCollection).get(0).longitude(), DELTA);
    assertEquals(1, TurfMeta.coordAll(featureCollection).get(4).latitude(), DELTA);
    assertEquals(1, TurfMeta.coordAll(featureCollection).get(4).longitude(), DELTA);
  }
  ...
  public void coordAllSingleFeature() throws TurfException {
    ...
    assertNotNull(featureCollection);
    assertEquals(2, TurfMeta.coordAll(featureCollection).size());
    assertEquals(0, TurfMeta.coordAll(featureCollection).get(0).latitude(), DELTA);
    assertEquals(0, TurfMeta.coordAll(featureCollection).get(0).longitude(), DELTA);
    assertEquals(1, TurfMeta.coordAll(featureCollection).get(1).latitude(), DELTA);
    assertEquals(1, TurfMeta.coordAll(featureCollection).get(1).longitude(), DELTA);
  }
  ...
  public void coordAllGeometryCollection() throws TurfException {
    ...
    assertNotNull(featureCollection);
    assertNotNull(TurfMeta.coordAll(featureCollection));
    assertEquals(3, TurfMeta.coordAll(featureCollection).size());
    assertEquals(1.0, TurfMeta.coordAll(featureCollection).get(0).longitude(), DELTA);
    assertEquals(2.0, TurfMeta.coordAll(featureCollection).get(0).latitude(), DELTA);
  }
